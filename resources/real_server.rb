...
property :conf_directory,     String, default: '/etc/keepalived/servers.d'
property :config_file,        String, default: lazy { ::File.join(conf_directory, "keepalived_real_server__#{ipaddress}-#{port}__.conf") }
